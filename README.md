...
6. Create an account with email and password, then sign in from any laptop.
...
TEA uses Supabase email/password authentication. In Supabase Authentication Providers, keep Email enabled. If email confirmation is enabled, new users must confirm their account before signing in.
